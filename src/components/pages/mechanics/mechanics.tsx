...
const MechanicsPage: React.FC<Props> = () => {
  let history = useHistory();
  const generalBrands = [{ name: 'BMW', id: 'bmw' }, { name: 'Skoda', id: 'sk' }];
  const additionalBrands = [{ name: 'Alfa Romeo', id: 'ar' }];

  const generalSpecialization = [{ name: 'Silnik', id: 'sil' }, { name: 'Zawieszenie', id: 'zaw' }];
